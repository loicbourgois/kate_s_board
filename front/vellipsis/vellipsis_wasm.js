...
export class Simulation {
    ...
    * @returns {number}
    */
    add_node_4(config_str) {
        const ptr0 = passStringToWasm0(config_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.simulation_add_node_4(this.__wbg_ptr, ptr0, len0);
        return ret >>> 0;
    }
    /**
    * @param {number} id
    ...
    */
    delete_node(idx) {
        wasm.simulation_delete_node(this.__wbg_ptr, idx);
    }
    /**
    * @param {number} a
    * @param {number} b
    ...
    * @returns {number}
    */
    nodes_inactive_count() {
        const ret = wasm.simulation_nodes_inactive_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    ...
    * @returns {number}
    */
    links_inactive_count() {
        const ret = wasm.simulation_links_inactive_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('vellipsis_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
